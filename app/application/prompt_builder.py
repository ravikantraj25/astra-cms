...
def build_planner_prompt(
    ...
    lines.append("")
    lines.append("CRITICAL PLANNER RULES:")
    lines.append("1. You MUST explicitly enforce the 'required_updates'. Ensure your action and fields_to_update reflect them.")
    lines.append("2. You MUST strictly adhere to the 'forbidden_updates'. Your fields_to_preserve and forbidden_changes must include them.")
    lines.append("3. Base your decisions directly on the deterministic 'editing_policy'.")
    lines.append("")
    lines.append("-" * 60)
